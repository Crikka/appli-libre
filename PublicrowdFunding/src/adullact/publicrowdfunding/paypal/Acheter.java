package adullact.publicrowdfunding.paypal;
 ...
 */
public class Acheter extends Activity {
    ...
    public void onBuyPressed(View pressed) {
        ...
        Intent intent = new Intent(Acheter.this, PaymentActivity.class);
    ...
    public void onFuturePaymentPressed(View pressed) {
        Intent intent = new Intent(Acheter.this, PayPalFuturePaymentActivity.class);
